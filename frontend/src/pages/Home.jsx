      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Jadi pelapor aktif */}
            <div className="bg-white border-2 border-gray-200 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="bg-gradient-to-br from-primary-50 to-primary-100 h-40 sm:h-48 flex items-center justify-center">
            ...
            {/* Ikut aksi bersih */}
            <div className="bg-white border-2 border-gray-200 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="bg-gradient-to-br from-green-50 to-green-100 h-40 sm:h-48 flex items-center justify-center">
                <svg className="w-16 h-16 sm:w-20 sm:h-20 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Edukasi sekitar */}
            <div className="bg-white border-2 border-gray-200 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow md:col-span-2 lg:col-span-1">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 h-40 sm:h-48 flex items-center justify-center">
          ...
          {/* Quote Box */}
          <div className="mt-10 sm:mt-12 bg-gradient-to-r from-primary-50 to-green-50 border-l-4 border-primary-500 rounded-xl p-6 sm:p-8">
            <div className="flex items-start">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-primary-500 mr-4 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
              <div>
                <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">
                ...
                <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
                  Perubahan besar dimulai dari langkah kecil kita. Dengan berpartisipasi aktif, kita bisa menciptakan lingkungan yang lebih bersih dan sehat untuk generasi mendatang.
                </p>
              </div>
            </div>
          </div>
